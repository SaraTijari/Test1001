...
radio.on()
global connexion_established = False
key = "KEYWORD"
global connexion_key = None
nonce_list = []
baby_state = 0
set_volume(100)
...
def respond_to_connexion_request(key):
    ...
    if message_recu[4]=="0x01":
        i=message_recu.find(:)
        if i!=-1:
            challenge=message_recu[i+1:]
